    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          ...
          className={`w-full px-3 py-2 border rounded-md bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-blue-500 ${s3PathMissing
  ...
  const renderNameField = () => (
    <div>
      ...
      <input
        ...
        className={`w-full px-3 py-2 border rounded-md bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-blue-500 ${nameMissing
            ? 'border-red-400 dark:border-red-600'
            : 'border-slate-300 dark:border-slate-600'
          }`}
