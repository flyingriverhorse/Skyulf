...
export const useGraphStore = create<GraphState>()(
  ...
  onConnect: (connection: Connection) => {
    ...
    if (sourceNode && targetNode) {
      ...
      const modelTypes = ['basic_training', 'advanced_tuning', 'classification', 'regression', 'text_classification', 'segmentation', 'ensemble', 'EnsembleNode'];
      ...
      const modelSourceTypes = ['basic_training', 'advanced_tuning', 'model_training', 'hyperparameter_tuning', 'classification', 'regression', 'text_classification', 'segmentation'];
