...
|--------|------|--------|-------------|
| **0.6.x** | [changelog/0.6.x.md](changelog/0.6.x.md) | Active | Ensemble models — Voting / Stacking (v0.6.0); Ruff migration & config-parsing fixes (v0.6.1); Security & reliability hardening (v0.6.3) |
