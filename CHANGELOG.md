...
|--------|------|--------|-------------|
| **0.7.x** | [changelog/0.7.x.md](changelog/0.7.x.md) | Active | Model explainability — SHAP Explainability tab with Summary/Beeswarm/Dependence/Waterfall views + dark-mode chart readability fixes (v0.7.0) |
