...
|--------|------|--------|-------------|
| **0.6.x** | [changelog/0.6.x.md](changelog/0.6.x.md) | Active | Ensemble models — Voting / Stacking (v0.6.0); Ruff migration & config-parsing fixes (v0.6.1); Security & reliability hardening (v0.6.3 – v0.6.6); Training-button dataset guard & skyulf-core backlog cleanup (v0.6.7); Frontend reliability, refactoring & dark-mode UI polish sweep (v0.6.8) |
