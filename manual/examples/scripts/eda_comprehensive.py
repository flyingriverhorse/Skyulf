...
def main():
    ...
    if profile.outliers:
        ...
        console.print(
            f"Detected [red]{profile.outliers.total_outliers}[/red] outliers ({profile.outliers.outlier_percentage}%)"
        )
    ...
    if profile.causal_graph:
        ...
        console.print(
            f"Graph: {len(profile.causal_graph.nodes)} nodes, {len(profile.causal_graph.edges)} edges"
        )
