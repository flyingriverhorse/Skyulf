...
**SM-32 through SM-33H2 are DONE for their documented scopes. H2 passed personal serverless training/lifecycle and 240+3/no-op prediction acceptance on both engines. SM-33H3 is DONE for its documented scope: local review/gates and approved serverless run848857785722024 passed; pandas/Polars saved custom approval and240+3/no-op scoring verified. Matrix63 distinguishes verified recipes from optional/conditional limits. SM-34 is READY. New generic row predicates, group-aware splitting and data-quality thresholds are parked at the user's request.**
...
| SM-34 | Independent score/train schedules and training windows | SM-33H3 | READY | Editable independent score/train cron/timezone/pause controls; selected schedules enabled by default; explicit lookback/holdout/label windows; scoring needs no manual dates or retraining |
