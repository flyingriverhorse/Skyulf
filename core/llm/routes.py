...
def build_general_analysis_system_prompt(context_data: str) -> str:
    ...
    return (
        "You are a senior data scientist focused on understanding the dataset. "
        "Review the dataset notes below and reply in explaning.\n\n"
        f"DATA CONTEXT:\n{context_data}\n\n"
        "Guidelines:\n"
...
EDA_ASSISTANT_PROMPT_TEMPLATE = (
    "You are a senior data scientist guiding an exploratory analysis session for each analysis "
    "and must stay grounded in the provided evidence.\n\n"
    "EDA SESSION CONTEXT:\n{eda_context}\n\n"
    ...
    "Avoid speculative scenarios, avoid headings like 'Deeper Follow-Up Analyses', and keep the answer "
    "concise. Provide code only when a short (<=7 line) snippet is essential to perform the next step."
)
